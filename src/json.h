...
**/
enum json_value_type{JSON_STRING = 0, JSON_NUMBER, JSON_OBJECT, JSON_ARRAY, JSON_TRUE, JSON_FALSE, JSON_NULL};

/**
The error messages produced by the JSON parsers
**/
enum json_errors{JSON_OK, JSON_INCOMPATIBLE_TYPE, JSON_MEMORY, JSON_INCOMPLETE_DOCUMENT};
